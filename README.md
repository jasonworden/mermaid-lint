...
| Wardley map | `wardley-beta` | ✅ | `no-experimental`, `wardley-undefined-component`, `wardley-orphan-component`, `wardley-no-components` | Experimental; not covered by the Rust fast path — always falls back to mermaid.js |
