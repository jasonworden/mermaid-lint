...
| Tree view | `treeView-beta` | ✅ | `no-experimental`, `treeview-no-nodes`, `treeview-duplicate-sibling` | Experimental; indented or `├──` box-drawing form, node labels quoted or bare (bare needs mermaid ≥ 11.16) |
