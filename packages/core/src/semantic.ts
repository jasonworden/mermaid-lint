...
/**
 * Count of leading whitespace characters (each counts as one column). Both the
 * mindmap and treemap hierarchies are indentation-based, and Mermaid measures
 * their indent in characters — a tab counts as one, same as a space.
 */
