...
/** A code-fence marker style recognized for Mermaid blocks. */
export type FenceMarker = 'backtick' | 'tilde';

/** Every supported marker — the default set, matching CommonMark. */
...
/** True when `value` is a recognized fence-marker name. */
