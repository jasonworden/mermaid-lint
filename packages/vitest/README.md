...
[Vitest](https://vitest.dev) adapter for [mermaid-lint](https://github.com/jasonworden/mermaid-lint). Turns every Mermaid diagram in your docs into a test — your suite fails if a diagram has a syntax error. Uses the official `mermaid.parse()` API.
